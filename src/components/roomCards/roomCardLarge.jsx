...
export default function RoomCardsLarge({ option, bookingParams, chooseRoom }){
                                    ...
                                    <div className={ styles["room-card__content"] }>
                                        ...
                                        <div className={ styles["room-card__footer"] }>
                                            ...
                                            { 
                                                ...
                                                option === "select" ? <button className={ styles["room-card__button"] } onClick={(event) => chooseRoom(event, item)}>Выбрать</button> : ""
                                            }
                                        </div>
                                    </div>
                                </div>
